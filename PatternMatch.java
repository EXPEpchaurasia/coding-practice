public class PatternMatch {
	...
	public static boolean isMatch(String pattern, String str) throws Exception {
		...
		if(EMPTY.equals(pattern) && EMPTY.equals(str) || (".*".equals(pattern) && EMPTY.equals(str))) {
			return true;
		}
		...
		if(isLooper(patternPrefix)) {                               // cases like “a*” or “.*” etc
			...
			return (pattern.charAt(0) == str.charAt(0)) &&  isMatch(pattern.substring(1), str.substring(1));

 ...
 *
 * Related Links :
 * GeeksForGeeks : https://www.geeksforgeeks.org/count-palindrome-sub-strings-string/
 * InterviewBit : https://www.interviewbit.com/problems/palindrome-partitioning-ii/
 * Youtube Tutorial : https://www.youtube.com/watch?v=WPr1jDh3bUQ
 */
public class PalindromePartitioning {
    ...
    public static int getMaxPalindromeCount(String str) {
        ...
        for (int palLen = 3; palLen <= length; ++palLen) {
            for (int start = 0; start <= length - palLen; ++start) {
                ...
                isPalindrome[start][end] =
                        isPalindrome[start + 1][end - 1] && (str.charAt(start) == str.charAt(end));
                maxPalindrome[start][end] =
                        maxPalindrome[start][end - 1] + maxPalindrome[start + 1][end]
                                - maxPalindrome[start + 1][end - 1] + (isPalindrome[start][end] ?
                                1 :
                                0);
        ...
        System.out.println("isPalindrome array is : ");
        printArray(isPalindrome);
        System.out.println("maxPalCount array is : ");
        printArray(maxPalindrome);
